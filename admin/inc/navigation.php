<!-- <style>
  .nav-link {
    ...
    background-color: lightgreen !important; /* Change background */
} -->

</style>
</style>
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-primary text-white bg-green disabled elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
