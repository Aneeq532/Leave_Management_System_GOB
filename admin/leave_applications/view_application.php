...
<div class="container-fluid">
    ...
    <p class="m-0"><b>Employees ID: </b> <br><span class="mx-2"><?php echo $employee_id ?></span></p>
...
<p class="m-0"><b>Reasons: </b><br><span class="mx-2"><?php echo $reason ?></span></p>
...
<?php if($status == 2 && !empty($deny_reason)): ?>
    <div class="form-group">
        <label><b>Reason for Denial:</b></label>
        <p class="text-danger mx-2"><?php echo $deny_reason ?></p>
    </div>
<?php endif; ?>
